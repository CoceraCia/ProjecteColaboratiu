...
public class Update extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        photo.setText("<html><center>(Drop your file here)</center></br><br><html><center>PHOTO</center></br><br><center> <i>Supported format: PNG.</i></center></br><br><center><i>Max. size 64KB</i></center></html>");
